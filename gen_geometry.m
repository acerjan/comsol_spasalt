function [ filename ] = gen_geometry( geom )
...
% n_back = 2.83;
% a = 0.22;
% lx = 2*0.084; %%% length of rod along x (major axis)
% ly = 2*0.060; %%%% length of rod along y
% asemiaxis = ly/2;
% bsemiaxis = lx/2;
%%% parameter of topological defect
%k = 1;  
%c = pi/4;  
%%%%%%%%%%%%%%%%
...
%   model.geom('geom1').feature('b9').set('p',{'0 1 1 0 0; 0 0 1 1 0'});
%   model.geom('geom1').feature('b9').set('w',{'1' '1' '1' '1' '1' '1' '1' '1'});  
%   model.geom('geom1').feature('b9').set('degree',[1 1 1 1 1 1 1 1]);  
%   model.geom('geom1').run('b9');

% model.geom('geom1').run('e0');
